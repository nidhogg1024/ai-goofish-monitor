...
const enUS = {
  ...
  header: {
    ...
    searchTooltip: 'Search is only available on the dashboard',
    adminUser: 'Admin',
  ...
  dashboard: {
    ...
    stats: {
      ...
      enabledAndRunning: '{enabled} enabled · {running} running',
  ...
  results: {
    ...
    insights: {
      ...
      trendReadingLabel: 'Trend Reading',
    ...
    chart: {
      dailyPriceCurve: 'Daily Price Curve',
      trendDescription: 'Daily price trend chart showing average and median prices',
      avgPrice: 'Average',
      medianPrice: 'Median',
  ...
  logs: {
    title: 'Logs',
    viewDescription: 'Centralized log viewer grouped by category, task group, and task to streamline troubleshooting.',
    ...
    running: 'Running',
    contextHint: 'Jump to the task configuration or view the task result insights from here.',
    goToTasks: 'Back to Tasks',
  ...
  settings: {
    ...
    ai: {
      ...
      modelSelectPlaceholder: 'Choose from fetched models first',
      availableModelsGroup: 'Verified available',
      unavailableModelsGroup: 'Currently unavailable',
      manualEntryOption: 'Enter model name manually',
      manualModelName: 'Custom model name',
      manualModelPlaceholder: 'Type a model name if the catalog does not include it',
      currentModelUnavailable: 'Current model {model} is unavailable: {reason}',
      refreshModels: 'Fetch model list',
      loadingModels: 'Loading...',
      modelsLoaded: 'Model list refreshed',
      loadModelsFailed: 'Failed to load model list',
      modelSource: 'Model catalog source: {source}',
      modelListHint: 'Fetch the available models after filling in API settings, or enter one manually.',
      probeSummary: '{available}/{total} models verified as available',
      unavailableSummary: '{count} models are currently unavailable',
