const enUSExtra = {
  tasks: {
    title: 'Tasks',
    viewDescription: 'Manage your monitoring pool by category and task group to keep different targets organized.',
    defaults: {
    ...
    category: {
      summary: '{total} tasks, {groups} groups, {running} running',
      groupBadge: '{count} groups',
    },
    group: {
      taskCount: '{count} candidate tasks',
    ...
    form: {
      ...
      category: 'Category',
      categoryPlaceholder: 'e.g. Robot Vacuum, Phones, Cameras',
      categoryHint: 'Optional. The system will auto-categorize based on task content.',
      group: 'Task Group',
      groupPlaceholder: 'e.g. Two Cats Rental, Daily Driver Upgrade, Samples & Stock',
      groupHint: 'Multiple models with the same purchase intent should share one group.',
      searchQuery: 'Search Query',
      searchQueryPlaceholder: 'e.g. Dreame Robot Vacuum (leave empty to use keyword above)',
      searchQueryHint: 'Search Goofish with broader terms, then filter by keyword. Leave empty to search directly by keyword.',
      cronPresetHint: 'Default presets stagger execution times with existing tasks to avoid burst triggering.',
    ...
    table: {
      ...
      executing: 'Running',
      queued: 'Queued',
      viewResults: 'View results for {task}',
      viewLogs: 'View logs for {task}',
      start: 'Start',
  ...
  accounts: {
    ...
    toasts: {
      ...
      invalidJsonDescription: 'Please paste valid JSON content.',
    },
  },
  notifyPanel: {
